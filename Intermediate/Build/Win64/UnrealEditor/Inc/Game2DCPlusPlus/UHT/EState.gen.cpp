...
struct Z_Construct_UEnum_Game2DCPlusPlus_EState_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "BlueprintType", "true" },
		{ "Buried.DisplayName", "Buried" },
		{ "Buried.Name", "EState::Buried" },
		...
		{ "DodgeIFrames.DisplayName", "DodgeIFrames" },
		{ "DodgeIFrames.Name", "EState::DodgeIFrames" },
		...
		{ "LaunchedAirborne.DisplayName", "LaunchedAirborne" },
		{ "LaunchedAirborne.Name", "EState::LaunchedAirborne" },
		{ "ModuleRelativePath", "Data/Enums/EState.h" },
		{ "ParryActive.DisplayName", "ParryActive" },
		{ "ParryActive.Name", "EState::ParryActive" },
		{ "ParryRecovery.DisplayName", "ParryRecovery" },
		{ "ParryRecovery.Name", "EState::ParryRecovery" },
		{ "ParryStartup.DisplayName", "ParryStartup" },
		{ "ParryStartup.Name", "EState::ParryStartup" },
		{ "RecoverBeam.DisplayName", "Firing Beam" },
		{ "RecoverBeam.Name", "EState::RecoverBeam" },
		{ "Staggered.DisplayName", "Staggered" },
		{ "Staggered.Name", "EState::Staggered" },
		...
		{ "WallImpact.DisplayName", "WallImpact" },
		{ "WallImpact.Name", "EState::WallImpact" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EState::Idle", (int64)EState::Idle },
		{ "EState::ParryStartup", (int64)EState::ParryStartup },
		{ "EState::ParryActive", (int64)EState::ParryActive },
		{ "EState::ParryRecovery", (int64)EState::ParryRecovery },
		{ "EState::DodgeIFrames", (int64)EState::DodgeIFrames },
		{ "EState::Staggered", (int64)EState::Staggered },
		{ "EState::WallImpact", (int64)EState::WallImpact },
		{ "EState::Buried", (int64)EState::Buried },
		{ "EState::LaunchedAirborne", (int64)EState::LaunchedAirborne },
		...
		{ "EState::RecoverBeam", (int64)EState::RecoverBeam },
...
struct Z_CompiledInDeferFile_FID_Users_natha_Documents_Unreal_Projects_Game2DCPlusPlus_5_6_5_7_Source_Game2DCPlusPlus_Data_Enums_EState_h__Script_Game2DCPlusPlus_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EState_StaticEnum, TEXT("EState"), &Z_Registration_Info_UEnum_EState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2703452667U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_natha_Documents_Unreal_Projects_Game2DCPlusPlus_5_6_5_7_Source_Game2DCPlusPlus_Data_Enums_EState_h__Script_Game2DCPlusPlus_1736247683(TEXT("/Script/Game2DCPlusPlus"),
	nullptr, 0,
	nullptr, 0,
